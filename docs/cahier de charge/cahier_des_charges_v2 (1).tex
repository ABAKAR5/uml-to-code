...
\hline
\rowcolor{lightgray}
6 & Démonstration live & Application hébergée — \href{https://uml-to-code-peach.vercel.app}{uml-to-code-peach.vercel.app} & 26/05/2026 \\
\hline
\end{tabularx}
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item L'application est déployée et accessible en ligne sur \href{https://uml-to-code-peach.vercel.app}{\texttt{uml-to-code-peach.vercel.app}}
