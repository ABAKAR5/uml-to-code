...
function App() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setServerCode(response.data.server_code || "")
  ...
  >
    <option value="false">⚙️ Algorithmique</option>
    <option value="true">🤖 IA (Groq)</option>
  </select>
</div>
  ...
  <div className="card">
    <div className="code-header">
      <h2>🌐 Serveur Flask généré automatiquement</h2>
      <div className="toolbar">
